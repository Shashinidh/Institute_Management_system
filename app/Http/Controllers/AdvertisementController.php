...
class AdvertisementController extends Controller
{
            ...
            if ($request->isMethod('POST')) {
                if (isset($isFileUploaded) && isset($isImageFileUploaded)) {
                    try {
                        ...
                        if ($create) {
                            return redirect('api/advertisement/show')->with('success', 'Advertisement created successfully');
                        } else {
                            return redirect('api/advertisement/show')->with('error', 'Advertisement not created');
                        }
            ...
            if ($request->isMethod('POST')) {
                if (isset($isFileUploaded) && isset($isImageFileUploaded)) {
                    try {
                        ...
                        if ($update) {
                            return redirect('api/advertisement/show')->with('success', 'Advertisement Updated successfully');
                        } else {
                            return redirect('api/advertisement/show')->with('error', 'Advertisement not Updated');
                        }
    ...
    public function destroy($id)
    {
        ...
        if ($response > 0) {
            return redirect('api/advertisement/show')->with('success', 'Advertisement Deleted successfully');
        } else {
            return redirect('api/advertisement/show')->with('error', 'Advertisement not Deleted');
        }

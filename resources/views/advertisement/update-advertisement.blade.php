...
@section('content')
    ...
    <section class="container">
        <div class="container px-5">
            <form method="post" action="{{url('api/advertisement/update/'.$advertisement['a_id'])}}"
                  enctype="multipart/form-data">
                @csrf
                <div class="row d-flex justify-content-end">
                    <input name="adID" type="text" class="form-control col-4 mr-3" id="adID"
                           placeholder="ID" value="{{$advertisement['a_id']}}" readonly disabled>
                    <input name="date" type="text" class="form-control col-4" id="date"
                           placeholder="Date" onfocus="(this.type='date')" value="{{$advertisement['date']}}">
                </div>
                <div class="row mt-4">
                    <div class="mb-3 col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="card" id="imgCard">
                            <img src="{{url('storage/'.$advertisement['img'])}}"
                                 class="card-img-top"
                                 height="265"
                                 id="adsImg"
                                 alt="...">
                    ...
                    <div class="mb-3 col-lg-6 col-md-6 col-sm-6">
                        <div class="card" id="videoCard">
                            ...
                            <video id="videoSourse" width="100%" height="100%" controls autoplay loop preload="auto"
                                   src="{{url('storage/videos/'.$advertisement['video'])}}">
                                <source id="videoSourse" src="{{url('storage/videos/'.$advertisement['video'])}}">
                ...
                <div class="row mb-3">
                    <div class="col p-0">
                        <select value="{{$advertisement['category']}}" class="form-control"
                    ...
                    <div class="col p-0">
                        <input type="text" class="form-control" id=" title" name="title"
                               placeholder="Title" value="{{$advertisement['title']}}">
                    </div>
                </div>
                <div class="row pb-3">
                    <div class="col p-0">
                    ...
                    <div class="col p-0 d-flex justify-content-end align-items-center">
                        <div class="btn-group">
                            ...
                            <a href="{{url('api/advertisement/show')}}" class="btn btn-secondary" type="button">View</a>
                        </div>
                    </div>
                </div>
            </form>

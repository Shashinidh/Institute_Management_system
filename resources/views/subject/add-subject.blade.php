...
@section('content')
    ...
    <section class="container">
        <div class="container px-5">
            <form method="post" action="{{url('api/subject/create')}}" enctype="multipart/form-data">
                @csrf
                <div class="row d-flex justify-content-end">
                    ...
                    <div class="mb-3 col-lg-6 col-md-6 col-sm-6 p-0">
                        <select class="form-control" aria-label="Default select example" name="subjectStream">
                ...
                <div class="row pb-3">
                    ...
                    <div class="col p-0 d-flex justify-content-end align-items-center">
                        <div class="btn-group">
                            ...
                            <a href="{{url('api/subject/show')}}" class="btn btn-secondary" type="button">View</a>
                        </div>
                    </div>
                </div>
            </form>
